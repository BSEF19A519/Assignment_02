...
public class Menu extends AppCompatActivity {
    ...
    public void Conjunctions(View view) {
        ...
        String conjunction = "Conjunctions are words that link other words, phrases, or clauses together.\n" +
                ...
                "\n" +
                "Not only am I finished studying for English, but I’m also finished writing my history essay. I am finished with both my English essay and my history essay."+"Subordinating Conjunctions\n" +
    ...
    public void Articles(View view) {
        ...
        String article = "Articles are words that define a noun as specific or unspecific. Consider the following examples:\n" +
                ...
                "By using the article a, we’ve created a general statement, implying that any cup of tea would taste good after any long day."+"The Definite Article\n" +
